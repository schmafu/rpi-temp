 ...
 *
 * ds18 reads the temperature on a raspberry pi using the ds18b20 sensor and stores the data in a dynamoDB.
...
readTemperature.then(function(data) {
    "use strict";
    if(!data) { throw ("could not fetch temperature data");;}
    ...
    db.putItem(dbparams, function(err, data) {
        ...
        u// else     console.log(data);           // successful response
    });
}).catch(function(e) {
    "use strict";
